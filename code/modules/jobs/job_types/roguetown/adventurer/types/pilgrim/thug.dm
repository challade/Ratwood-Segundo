...
/datum/outfit/job/roguetown/adventurer/thug/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Goon")
			...
			H.adjust_skillrank(/datum/skill/labor/mining, SKILL_LEVEL_NOVICE, TRUE)
			...
			H.adjust_skillrank(/datum/skill/misc/stealing, SKILL_LEVEL_JOURNEYMAN, TRUE)
		...
		if("Miscreant")
			...
			H.adjust_skillrank(/datum/skill/labor/fishing, SKILL_LEVEL_APPRENTICE, TRUE)
			H.adjust_skillrank(/datum/skill/misc/reading, SKILL_LEVEL_APPRENTICE, TRUE)
		...
		if("Big Man")
			...
			H.adjust_skillrank(/datum/skill/misc/swimming, SKILL_LEVEL_APPRENTICE, TRUE)
			H.adjust_skillrank(/datum/skill/misc/climbing, SKILL_LEVEL_APPRENTICE, TRUE)
			H.adjust_skillrank(/datum/skill/labor/mining, SKILL_LEVEL_JOURNEYMAN, TRUE)
			H.adjust_skillrank(/datum/skill/labor/lumberjacking, SKILL_LEVEL_JOURNEYMAN, TRUE)
